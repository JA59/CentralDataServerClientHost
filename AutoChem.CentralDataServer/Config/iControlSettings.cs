...
namespace AutoChem.Core.CentralDataServer.Config
{
    ...
    /// <summary>
    /// Settings specific or at least with different values for iControl experiments.
    /// </summary>
    [DataContract(Namespace = ServicesHelper.TypeNameSpace)]
    [Serializable]
    public class iControlSettings : DeviceSettings
    {
        /// <summary>
        /// The file specifying the default report content for iControl experiments when iControl is connected to the collation server.
        /// </summary>
        [DataMember]
        public string DefaultReportTemplateFile { get; set; }
