...
namespace AutoChem.Core.CentralDataServer.Instruments
{
    ...
    /// </summary>
    public class InstrumentManagementClient : ClientBase<IInstrumentManagementService>, IInstrumentManagementService
    {
        /// <summary>
        /// Constructor
        /// </summary>
        ...
        public InstrumentManagementClient(Binding binding, EndpointAddress remoteAddress) :
        ...
        {
            return Channel.GetRegisteredInstruments();
        }
